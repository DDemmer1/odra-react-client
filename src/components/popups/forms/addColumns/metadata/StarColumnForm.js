...
class StarColumnForm extends Component {
    ...
    render() {
        return (
            <div>
                <h5 className="text-center mt-3" style={{fontSize: "1rem"}}>Add a Star column</h5>
                <hr/>
                <form onSubmit={(event) => {
...
StarColumnForm = Radium(StarColumnForm);

export default StarColumnForm;